#!./.env/bin/python3
# -*- coding: utf-8 -*-
# Time-stamp: "2024-07-12 00:48:38 (ywatanabe)"
# /mnt/ssd/ripple-wm-code/scripts/NT/_NT2df.py
...
def NT2df(lpath_NT, sample_type, znorm=False, symlog=False, unbias=False):
    # Loading
...
def main():
    ...
    df = NT2df(lpath_NT, sample_type="all")
